...
<body>
	...
	<%
		ArrayList<Passenger> passengerList = (ArrayList<Passenger>)session.getAttribute("passengers");
		if(passengerList == null){
			passengerList = new ArrayList<>();
		}
		
		//... page recursive tant que il reste des gens à inscrire ?
